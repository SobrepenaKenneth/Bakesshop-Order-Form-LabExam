...
public class BakeshopOrderForm extends JFrame {
	...
	public BakeshopOrderForm() {
		...
		lblPancakeImage.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/Pastry1.png")));
		...
		lblCroissantImage.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/croissant.png")));
		...
		lblDeliveryImage.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/delivery (1).png")));
		...
		lblChocolateCakeSliceImg
				.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/chocolate cake slice.png")));
		...
		lblMiniCakeImage.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/mini cake.png")));
		...
		lblBrowniesImg.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/brownies.png")));
		...
		lblEnsaymadaImg.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/ensaymada.png")));
		...
		lblCroissantImg.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/croissant1.png")));
		...
		lblPandesalImg.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/pandesal.png")));
		...
		lblChocolateChipCookieImg
				.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/chocolate chip cookie.png")));
		...
		lblOatmealCookieImg
				.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/oatmeal cookie.png")));
		...
		lblCrinklesImg.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/crinkles.png")));
		...
		lblBirthdayCandleImg
				.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/bday candle set.png")));
		...
		lblCakeTopperImg.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/cake topper.png")));
		...
		lblGreetingsCardImg
				.setIcon(new ImageIcon(BakeshopOrderForm.class.getResource("/labExam/greeting card.png")));
